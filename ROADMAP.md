...
**Last updated:** 2026-07-05 (Merged to `main`, Vercel Production now tracks `main`, GitHub Pages retired — Supabase project is the last piece of the rollback net still live)
...
- **Full cutover: merged to `main`, GitHub Pages retired (2026-07-05).** After a short burn-in on the branch preview, the user confirmed everything works and pushed the whole migration through:
  ...
  - **Only remaining rollback-net piece: the Supabase project itself, still live and unpaused.** Deliberately left as the final safety net — revisit pausing it after a few more days of confidence on the merged stack.
