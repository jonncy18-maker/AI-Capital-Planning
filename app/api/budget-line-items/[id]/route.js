...
// entirely on RLS in the original backend to prevent cross-user access. Neon
// has RLS stripped (custom API layer enforces authorization instead), so this route
